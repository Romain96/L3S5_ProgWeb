<h1 class="text-center">Administration - toutes les vidéos</h1>

<h2 class="text-center">
	<a href="<?=BASEURL?>/index.php/video/creer_video">Ajouter une vidéo</a>
</h2>

<?php if( empty($videos) ) { ?>

<p class="text-center">Il n'y a pas de vidéos dans la base :(</p>
